    ...
    return(
      <div className="pri">
        <div className="home_data">
            <h1 className="home_title" >Priyansh Mathur&nbsp;
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            <h3 className="home_subtitle">A MERN Stack Developer</h3>
            <p className="home_description"> I am a Mern Stack Developer based in India, and I am very passionate and dedicated 
                to my work. </p>
            <a href="#contact" className="button button_ancho butto--flex">Say Hello &nbsp;<i className="fa-solid fa-paper-plane"></i></a>
        </div>
        </div>
    )
}
